...
yum install nginx postgresql$pgsql-server wget python3  snapd unzip mc bzip2 traceroute atop htop iftop -y
echo
echo
echo
...
rm -f ./aws_install_software_web_server_with_db_postgresql_centos7.sh
echo
reboot
